...
\resheading{Experience}
	\begin{itemize}
		\item 
            ...
            \ressubheading{}{}{System Administrator for Software Reliability Testing}{Sept. 2014 -- Present}
          { \footnotesize
				\begin{itemize}
					\resitem{Developed and implemented models for relibilty testing}
					\resitem{Used Git and Github as means of open source software development}
...
\item[Wheelcahir Control System:] { \footnotesize an embedded systems design project with the intended purpose of driving a wheelchair. RTOS built in C which focuses on reliabilty, saftey, and convience of the user in mind.}
